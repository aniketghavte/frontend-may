...
import ex_bg from '../../../public/treasure.jpg'
...
const Giveaway = () => {
  ...
  console.log(router.query.bountyId)
  useEffect(() => {
    ...
    if(router.query.bountyId !== undefined ){
        ...
        .then(response => {
            ...
            console.log(response.data.data);
            toast.dismiss();
            setBountyData(response.data.data);
          })
          .catch(error => {
            console.log(error)
            toast.dismiss()
            toast.error('Looks like Bounty is not available');
    ...
    <div className={styles.app__exclusive}>
        ...
        <div className={styles.container2}>
            <div className={styles.block1}>
                <h1>{bountyData?.title}</h1>
                <div className={styles.desc_give}>
                    {
                        bountyData?.desc?.map((item , index) => {
                            return(
                                <p>{item}</p>
                            )
                        })
                ...
                <div className={styles.desc_give}>
                    ...
                    {
                        bountyData?.criteria?.map((item, index) => {
                            return(
                                <p>{item}</p>
                            )
                        })
                ...
                <div className={styles.desc_give}>
                    <p><span>Note:- </span></p>
                    {
                        bountyData?.note?.map((item, index) => {
                            return(
                                <p>{item}</p>
                            )
                        })
